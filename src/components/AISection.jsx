            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-8 leading-tight text-gray-800">
                  Proactive procurement, powered by <span className="text-[#8b5cf6]">AI</span>
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a 
                    href="/ai-features"
                    className="inline-flex items-center bg-[#8b5cf6] text-white px-8 py-4 rounded-full font-semibold hover:bg-[#7c3aed] transition-all duration-200 transform hover:scale-105 shadow-lg"
                  >
                    Explore AI features
                  ...
                  <a 
                    href="/demo"
                    className="inline-flex items-center text-[#8b5cf6] hover:text-[#7c3aed] font-semibold transition-colors duration-200"
                  >
                    Watch AI demo
                    <svg className="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
