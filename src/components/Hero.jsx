const Hero = () => {
  return (
    <section className="bg-gradient-to-b from-[#3d2b5e] via-[#2a1b3e] to-[#2d1b4e] text-white relative overflow-hidden">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              ...
              <h1 className="mt-6 text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-light leading-tight">
          ...
          <div className="mt-16 flex justify-center">
            <div className="w-full max-w-2xl relative">
              <div className="bg-gradient-to-br from-[#3d2b5e]/20 to-[#2a1b3e]/20 rounded-2xl p-4 backdrop-blur-sm">
                <iframe 
